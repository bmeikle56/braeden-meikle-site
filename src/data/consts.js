...
const bioMeta = {
  ...
  bio: `
    ...
    tennis and golf. I went to The Potomac School in McLean, Virginia, 
    before attending Georgia Tech to study Computer Science. In my 
    free time, I enjoy reading, poker, coding, running, and keeping 
    this site up. A fervent supporter of Washington pro sports, I 
    closely follow the Capitals, Wizards, and Commanders.
  `
}
